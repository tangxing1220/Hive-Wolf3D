...
/*
    if (c->worldMap[c->map.x][c->map.y] == 1)
        ...
        color = COL_YELLOW;
    else if (c->worldMap[c->map.x][c->map.y] == 3)
        color = COL_GREEN;
    else if (c->worldMap[c->map.x][c->map.y] == 4)
        color = COL_BLUE;
    else if (c->worldMap[c->map.x][c->map.y] == 5)
        color = COL_CORAL;
    else if (c->worldMap[c->map.x][c->map.y] == 6)
        color = COL_SKY_BLUE;
    else if (c->worldMap[c->map.x][c->map.y] == 7)
        color = COL_ORANGE_RED;
    else 
        color = COL_WHITE;
