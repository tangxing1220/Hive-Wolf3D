...
void print_usage(void)
{
    ...
    ft_putstr_fd("map: maps/map1.txt\tmaps/map2.txt\tmaps/map3.txt\n", STDERR_FILENO);
}
...
void calc_ray(t_combi *c, int x, int map[MAP_HEIGHT][MAP_WIDTH])
{
    int stepX;
    int stepY;
    int hit;
