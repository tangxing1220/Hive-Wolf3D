...
void for_back_ward(t_combi *combi, int map[MAP_HEIGHT][MAP_WIDTH])
{
    double movspeed;
    ...
    {
        if (map[(int)(combi->player->pos.x + combi->player->posdir.x * movspeed)][(int)(combi->player->pos.y)] == 0)
            combi->player->pos.x += combi->player->posdir.x * movspeed;
        if (map[(int)(combi->player->pos.x)][(int)(combi->player->pos.y + combi->player->posdir.y * movspeed)] == 0)
            combi->player->pos.y += combi->player->posdir.y * movspeed;
    }
