...
void for_back_ward(t_combi *combi)
{
    ...
    {
        if (worldMap[(int)(combi->player->pos.x + combi->player->posdir.x * movspeed)][(int)(combi->player->pos.y)] == 0)
            combi->player->pos.x += combi->player->posdir.x * movspeed;
        if (worldMap[(int)(combi->player->pos.x)][(int)(combi->player->pos.y + combi->player->posdir.y * movspeed)] == 0)
